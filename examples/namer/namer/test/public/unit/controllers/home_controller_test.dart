  ...
  group('HomeController', () {
    ...
    test(
      ...
      try {
        ...
        // Chord builder / Show Me use pitch classes (0-11), not raw MIDI.
        controller.selectNotes({9, 0, 4}); // A, C, E → Amin classes
        controller.highlightNotes();
        ...
        expect(
          highlights
              .map((dp.KeyHighlightLEDMessage m) => (m.column, m.row))
              .toSet(),
          equals(<(int, int)>{(0, 0), (1, 0), (2, 0)}),
        );
      } finally {
